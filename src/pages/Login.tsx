...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Accept any credentials, store a simple flag
            ...
            <Card className="card-elevated">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-sm text-muted-foreground text-center">No account? <Link to="/signup" className="text-primary">Create one</Link></p>
                </form>
              </CardContent>
            </Card>
          </div>
